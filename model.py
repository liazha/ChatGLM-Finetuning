...
from utils import GLMPromptDataSet, GLM2PromptDataSet, GLM2MedPromptDataSet
...
MODE = {"glm": {"model": ChatGLMForConditionalGeneration, "tokenizer": ChatGLMTokenizer, "config": ChatGLMConfig,
        ...
        "glm2med": {"model": ChatGLM2ForConditionalGeneration, "tokenizer": ChatGLM2Tokenizer, "config": ChatGLM2Config,
                "dataset": GLM2MedPromptDataSet}
        }
